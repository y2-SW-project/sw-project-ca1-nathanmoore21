...
<body>
    ...
    <div class="body">
        ...
        <a href="{{ route('admin.jobs.index')}}">view all jobs here.</a>
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="update_h">
                            <a href="#"><i>We have <u>three</u> new job applications for Shop Assistant.</a></i></div>
                        <hr class="update">
                        <div class="update_h">
                            <a href="#"><i>We have <u>one</u> new job application for Retail Manager.</a></i></div>
                        <hr class="update">
                        <div class="update_h">
                            <a href="#"><i>We have <u>four</u> new job applications for Nightpack Assistant.</a></i>
                        </div>
                        <br>
                        <hr>
